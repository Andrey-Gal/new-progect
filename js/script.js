...
window.addEventListener("load", () => {
  // Всегда начинаем с верха страницы
...
console.log("Готово: замедленные анимации и стабильная загрузка.");
...
(function () {
  ...
  // ЖЁСТКО фиксируем положение стрелки инлайном — перебиваем любой старый CSS
